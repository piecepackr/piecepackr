* `extdata/by-sa.svgz` is a Creative Commons License "button mark" from https://github.com/creativecommons/cc-assets made available under the following license (https://creativecommons.org/policies):
