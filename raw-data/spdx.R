if (FALSE) {
	...
	rsvg::rsvg_svg(
		"raw-data/cc-assets/license_badges/big/by_nc.svg",
		"inst/extdata/badges/by-nc.svg"
	)
	compress("inst/extdata/badges/by-nc.svg")
	rsvg::rsvg_svg(
		"raw-data/cc-assets/license_badges/big/by_nd.svg",
		"inst/extdata/badges/by-nd.svg"
	)
	compress("inst/extdata/badges/by-nd.svg")
	rsvg::rsvg_svg(
		"raw-data/cc-assets/license_badges/big/by_nc_nd.svg",
		"inst/extdata/badges/by-nc-nd.svg"
	)
	compress("inst/extdata/badges/by-nc-nd.svg")
	rsvg::rsvg_svg(
		"raw-data/cc-assets/license_badges/big/by_nc_sa.svg",
		"inst/extdata/badges/by-nc-sa.svg"
	)
	compress("inst/extdata/badges/by-nc-sa.svg")
	rsvg::rsvg_svg(
		"raw-data/cc-assets/license_badges/big/by_sa.svg",
		"inst/extdata/badges/by-sa.svg"
	)
	compress("inst/extdata/badges/by-sa.svg")
	rsvg::rsvg_svg(
		"raw-data/cc-assets/license_badges/big/cc_zero.svg",
		"inst/extdata/badges/cc-zero.svg"
	)
	compress("inst/extdata/badges/cc-zero.svg")
	rsvg::rsvg_svg(
		"raw-data/cc-assets/license_badges/big/publicdomain.svg",
		"inst/extdata/badges/publicdomain.svg"
	)
...
if (TRUE) {
	...
	spdx_license_list <- mutate(
		...
		url_alt = ifelse(
			id == "CC0-1.0",
			"https://creativecommons.org/publicdomain/zero/4.0/",
			url_alt
		),
		badge = NA_character_
	)
	which_cc <- grep("^Creative Commons", spdx_license_list$name)
	spdx_license_list$name[which_cc] <- gsub(
		" Non Commercial",
		"-NonCommercial",
		spdx_license_list$name[which_cc]
	)
	spdx_license_list$name[which_cc] <- gsub(
		" Share Alike",
		"-ShareAlike",
